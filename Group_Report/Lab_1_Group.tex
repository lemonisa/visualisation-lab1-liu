...
install.packages(c("ggplot2","gridExtra","grid","ggrepel"))
library(ggplot2)
library(ggrepel)
library(gridExtra)
library(grid)
...
new_column_names <- c("ID","Length_of_stay","Age","Infection_Risk","Routine_Culturing_Ratio",
"Routine_Chest_Xray_Ratio","nr_of_beds","Med_school_aff","Region","Ave_Daily_Cens",
